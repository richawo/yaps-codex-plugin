...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="yaps-public-archive-") as temporary:
        ...
        fake_cli = workspace / "yaps cli; no-shell"
        fake_cli.write_text(
            f"""#!{node}
...
""",
        ...
        print(
            "archive_journey: all eleven standalone skill ZIPs discovered the "
            "validated CLI and recovered desktop settings without PATH"
        )
    return 0
