...
- `yaps-memory-plugin-<version>.zip`: upload this through the public plugin uploader. It contains the required `.codex-plugin/plugin.json` at the ZIP root plus the bundled skill.
