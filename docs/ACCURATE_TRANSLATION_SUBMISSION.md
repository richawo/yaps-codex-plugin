...
Use `dist/yaps-translation-plugin-0.1.10.zip` in the OpenAI Platform plugin portal. Upload it as a skills-only plugin; Yaps desktop 2.3.124 or newer supplies the credential-free automatic account handoff, local CLI, account state, translation models, language catalogue, and file handling.
