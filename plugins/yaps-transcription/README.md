...
After account access is active, choose **Yaps → Settings → General → Local AI integrations → Install CLI**. The current file-transcription path uses Yaps's local Subtitles/Whisper component and requires FFmpeg for media extraction.
