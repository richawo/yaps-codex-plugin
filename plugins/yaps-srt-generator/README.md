...
After account access is active, choose **Yaps → Settings → General → Local AI integrations → Install CLI**. Enable Subtitles under Yaps Features when prompted. FFmpeg is required for media extraction.
