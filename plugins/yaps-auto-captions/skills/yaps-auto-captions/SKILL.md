...
1. Confirm that Yaps 2.0.1 or later is installed through the runner. Do not ask the user to open it first, install models, or process media.
...
workflow in **Yaps → Media → Auto Captions**.
